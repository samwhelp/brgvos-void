...
dconf write /org/gnome/desktop/interface/gtk-theme "'WhiteSur-Dark-solid-red'"
dconf write /org/gnome/desktop/interface/icon-theme "'WhiteSur-red-dark'"

# set user theme for WhiteSur
dconf write /org/gnome/shell/extensions/user-theme/name "'WhiteSur-Dark-solid-red'"
