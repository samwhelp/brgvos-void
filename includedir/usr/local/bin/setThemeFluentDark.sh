...
dconf write /org/gnome/desktop/interface/gtk-theme "'Fluent-round-red-Dark'"
dconf write /org/gnome/desktop/interface/icon-theme "'Fluent-red-dark'"

# set user theme for Fluent
dconf write /org/gnome/shell/extensions/user-theme/name "'Fluent-round-red-Dark'"
