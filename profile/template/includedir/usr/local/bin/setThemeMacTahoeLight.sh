...
dconf write /org/gnome/desktop/interface/gtk-theme "'MacTahoe-Light-blue'"
dconf write /org/gnome/desktop/interface/icon-theme "'MacTahoe-blue-light'"

# set user theme for MacTahoe
dconf write /org/gnome/shell/extensions/user-theme/name "'MacTahoe-Ligt-blue'"

# set theme for accent-gtk-theme
dconf write /org/gnome/shell/extensions/accent-gtk-theme/blue-theme-dark "'MacTahoe-Dark-blue'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/blue-theme-light "'MacTahoe-Light-blue'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/green-theme-dark "'MacTahoe-Dark-green'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/green-theme-light "'MacTahoe-Light-grey'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/orange-theme-dark "'MacTahoe-Dark-orange'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/orange-theme-light "'MacTahoe-Light-orange'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/pink-theme-dark "'MacTahoe-Dark-pink'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/pink-theme-light "'MacTahoe-Light-pink'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/purple-theme-dark "'MacTahoe-Dark-purple'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/purple-theme-light "'MacTahoe-Light-purple'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/red-theme-dark "'MacTahoe-Dark-red'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/red-theme-light "'MacTahoe-Light-red'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/slate-theme-dark "'MacTahoe-Dark-grey'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/slate-theme-light "'MacTahoe-Light-grey'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/teal-theme-dark "'MacTahoe-Dark-blue'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/teal-theme-light "'MacTahoe-Light-blue'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/yellow-theme-dark "'MacTahoe-Dark-yellow'"
dconf write /org/gnome/shell/extensions/accent-gtk-theme/yellow-theme-light "'MacTahoe-Light-yellow'"
...
dconf write /org/gnome/shell/extensions/accent-user-theme/blue-theme-dark "'MacTahoe-Dark-blue'"
dconf write /org/gnome/shell/extensions/accent-user-theme/blue-theme-light "'MacTahoe-Light-blue'"
dconf write /org/gnome/shell/extensions/accent-user-theme/green-theme-dark "'MacTahoe-Dark-green'"
dconf write /org/gnome/shell/extensions/accent-user-theme/green-theme-light "'MacTahoe-Light-grey'"
dconf write /org/gnome/shell/extensions/accent-user-theme/orange-theme-dark "'MacTahoe-Dark-orange'"
dconf write /org/gnome/shell/extensions/accent-user-theme/orange-theme-light "'MacTahoe-Light-orange'"
dconf write /org/gnome/shell/extensions/accent-user-theme/pink-theme-dark "'MacTahoe-Dark-pink'"
dconf write /org/gnome/shell/extensions/accent-user-theme/pink-theme-light "'MacTahoe-Light-pink'"
dconf write /org/gnome/shell/extensions/accent-user-theme/purple-theme-dark "'MacTahoe-Dark-purple'"
dconf write /org/gnome/shell/extensions/accent-user-theme/purple-theme-light "'MacTahoe-Light-purple'"
dconf write /org/gnome/shell/extensions/accent-user-theme/red-theme-dark "'MacTahoe-Dark-red'"
dconf write /org/gnome/shell/extensions/accent-user-theme/red-theme-light "'MacTahoe-Light-red'"
dconf write /org/gnome/shell/extensions/accent-user-theme/slate-theme-dark "'MacTahoe-Dark-grey'"
dconf write /org/gnome/shell/extensions/accent-user-theme/slate-theme-light "'MacTahoe-Light-grey'"
dconf write /org/gnome/shell/extensions/accent-user-theme/teal-theme-dark "'MacTahoe-Dark-blue'"
dconf write /org/gnome/shell/extensions/accent-user-theme/teal-theme-light "'MacTahoe-Light-blue'"
dconf write /org/gnome/shell/extensions/accent-user-theme/yellow-theme-dark "'MacTahoe-Dark-yellow'"
dconf write /org/gnome/shell/extensions/accent-user-theme/yellow-theme-light "'MacTahoe-Light-yellow'"
...
dconf write /org/gnome/desktop/background/picture-uri "'file:///usr/share/backgrounds/gnome/mactahoe-l.png'"
dconf write /org/gnome/desktop/background/picture-uri-dark "'file:///usr/share/backgrounds/gnome/mactahoe-d.png'"
